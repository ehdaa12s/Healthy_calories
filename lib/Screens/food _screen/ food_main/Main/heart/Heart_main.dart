...
class heart_main extends StatefulWidget {
  const heart_main({Key? key}) : super(key: key);

  @override
  State<heart_main> createState() => _heart_mainState();
}

class _heart_mainState extends State<heart_main> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.blue[200],
        title: Text('اطعمه لمرضي القلب '),
      ),
      body: Padding(
