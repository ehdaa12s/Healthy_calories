...
class diabites_main extends StatefulWidget {
  const diabites_main({Key? key}) : super(key: key);

  @override
  State<diabites_main> createState() => _diabites_mainState();
}

class _diabites_mainState extends State<diabites_main> {
  @override
