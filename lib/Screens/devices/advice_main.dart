...
class adivice_main extends StatefulWidget {
  const adivice_main({Key? key}) : super(key: key);

  @override
  State<adivice_main> createState() => _adivice_mainState();
}

class _adivice_mainState extends State<adivice_main> {
  @override
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text('- يجب الكمامة أثناء الخروج من المنزل، تجنبا لدخول الهواء المحمل بالأتربة وحبوب اللباح، إلى مجرى الهواء العلوى والشعب الهوائية مما يسبب نوبات الربو الحساسية .'
                        '\n'
